	...
	return (
		...
		>
          ...
          <div className="col-span-12 text-big lg:text-bigger font-bold text-red-800 flex justify-center items-center">
			...
			>
				{!modal && (
					<div className='absolute -top-0 -right-0 w-0 h-0 bg-transparent border-solid border-t-[100px] border-r-[100px] border-l-transparent border-r-transparent border-t-primary z-10 rotate-90' />
				)}
				{!modal && (
					<div className='absolute bottom-0 left-0 w-0 h-0 bg-transparent border-solid border-t-[100px] border-r-[100px]  border-l-transparent border-r-transparent border-t-primary z-10 -rotate-90' />
				)}
				<p

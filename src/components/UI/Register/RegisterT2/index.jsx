...
function RegisterT2({ modal }) {
  ...
  return (
    ...
    >
      ...
      >
        {!modal && (
          <div className="absolute -top-[1px] -right-[1px] w-0 h-0 bg-transparent border-solid border-t-[100px] border-r-[100px] border-l-transparent border-r-transparent border-t-primary z-10 rotate-90" />
        )}
        {!modal && (
          <div className="absolute -bottom-[1px] -left-[1px] w-0 h-0 bg-transparent border-solid border-t-[100px] border-r-[100px]  border-l-transparent border-r-transparent border-t-primary max-md:border-t-third z-10 -rotate-90" />
        )}
        <p

...
const FloorPlanBuildingLayout = ({
  ...
  const FloorButton = ({ customStyle, i }) => {
    return (
      ...
      >
        {floorData.floors[i].name}
        <div className="relative">
          <div
            style={{ backgroundColor: floorData.floors[i].color }}
          ...
          >
            <p className="text-smaller font-semibold text-fourth">floorData</p>
            <p className="font-bold text-med">
              {floorData.floors[i].bedRoomNumber} {t("floorBedroom")}
            </p>
          </div>
        </div>
      </button>
